...
public class CenterAndStationPickupBlue extends SequentialCommandGroup {
  ...
  public CenterAndStationPickupBlue(DriveSubsystem drive, Navigation nav, Gripper gripper, Elevator elevator, IntakeArm arm, Intake intake, double elevatorScoringPosition1, double elevatorScoringPosition2) {
