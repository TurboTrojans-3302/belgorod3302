...
public class ReefSideTestL1Blue extends SequentialCommandGroup {
  ...
  int aprilTag = 21;
  Pose2d aprilTagPose;
  public ReefSideTestL1Blue(DriveSubsystem drive, Navigation nav, Gripper gripper, Elevator elevator) {
