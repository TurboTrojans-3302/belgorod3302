...
public class ReefSideTestL1 extends SequentialCommandGroup {
  ...
  int aprilTag;
  Pose2d aprilTagPose;
  public ReefSideTestL1(DriveSubsystem drive, Navigation nav, Gripper gripper, Elevator elevator, String alliance) {
